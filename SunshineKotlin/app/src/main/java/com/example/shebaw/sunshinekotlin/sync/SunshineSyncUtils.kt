...
object SunshineSyncUtils {
    ...
    fun scheduleFirebaseJobDispatcherSync(context: Context) {
        ...
        val syncSunshineJob = dispatcher.newJobBuilder()
                ...
                /* Set the UNIQUE tag used to indentify this Job */
    ...
    @Synchronized fun initialize(context: Context) {
         ...
         */
        val checkForEmpty = Thread {
            /* KOTLIN: The Lambda is implementing Runnable's run method */
             ...
             */
            val projectionColumns = arrayOf<String>(BaseColumns._ID)
